package net.sirgrantd.fabulous_blades.client.models;
...
public record FabulousBakedModel(BakedModel smallBakedModel, BakedModel largeBakedModel) implements BakedModel {
	@Override
