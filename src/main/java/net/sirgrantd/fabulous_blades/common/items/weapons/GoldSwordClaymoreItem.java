...
public class GoldSwordClaymoreItem extends FabulousWeapons {
	private static final Tier CLAYMORE_TIER = WeaponsTier.GOLD_TIER;

	private static final float ATTACK_DAMAGE = WeaponsConst.GOLD_WEAPON_ATTACK_DAMAGE + WeaponsConst.CLAYMORE_WEAPON_ATTACK_DAMAGE;
