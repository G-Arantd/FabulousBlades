...
public class GoldSwordLongbladeItem extends FabulousWeapons {
	private static final Tier LONGBLADE_TIER = WeaponsTier.GOLD_TIER;

	private static final float ATTACK_DAMAGE = WeaponsConst.GOLD_WEAPON_ATTACK_DAMAGE + WeaponsConst.LONGBLADE_WEAPON_ATTACK_DAMAGE;
