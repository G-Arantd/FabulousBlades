...
public class NetheriteSwordClaymoreItem extends FabulousWeapons {
	private static final Tier CLAYMORE_TIER = WeaponsTier.NETHERITE_TIER;

	private static final float ATTACK_DAMAGE = WeaponsConst.NETHERITE_WEAPON_ATTACK_DAMAGE + WeaponsConst.CLAYMORE_WEAPON_ATTACK_DAMAGE;
