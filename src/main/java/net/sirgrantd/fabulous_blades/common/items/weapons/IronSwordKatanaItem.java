...
public class IronSwordKatanaItem extends FabulousWeapons {
	private static final Tier KATANA_TIER = WeaponsTier.IRON_TIER;

	private static final float ATTACK_DAMAGE = WeaponsConst.IRON_WEAPON_ATTACK_DAMAGE + WeaponsConst.KATANA_WEAPON_ATTACK_DAMAGE;
