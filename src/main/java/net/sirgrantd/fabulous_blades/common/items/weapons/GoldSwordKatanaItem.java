...
public class GoldSwordKatanaItem extends FabulousWeapons {
	private static final Tier KATANA_TIER = WeaponsTier.GOLD_TIER;

	private static final float ATTACK_DAMAGE = WeaponsConst.GOLD_WEAPON_ATTACK_DAMAGE + WeaponsConst.KATANA_WEAPON_ATTACK_DAMAGE;
