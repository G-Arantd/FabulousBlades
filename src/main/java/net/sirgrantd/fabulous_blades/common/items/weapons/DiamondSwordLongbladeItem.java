...
public class DiamondSwordLongbladeItem extends FabulousWeapons {
	private static final Tier LONGBLADE_TIER = WeaponsTier.DIAMOND_TIER;

	private static final float ATTACK_DAMAGE = WeaponsConst.DIAMOND_WEAPON_ATTACK_DAMAGE + WeaponsConst.LONGBLADE_WEAPON_ATTACK_DAMAGE;
	...
	public DiamondSwordLongbladeItem() {
