...
public class DiamondSwordKatanaItem extends FabulousWeapons {
	private static final Tier KATANA_TIER = WeaponsTier.DIAMOND_TIER;

	private static final float ATTACK_DAMAGE = WeaponsConst.DIAMOND_WEAPON_ATTACK_DAMAGE + WeaponsConst.KATANA_WEAPON_ATTACK_DAMAGE;
